...
public class MainActivity extends AppCompatActivity {
    ...
    private void startAudioRec()  {
            ...
            mVideoFileName = "VOICE" + currentDateFormat() + ".mp4";
            mMediaRecorder.setOutputFile(Environment.getExternalStorageDirectory().getPath() + "/Music/" + mVideoFileName);
    ...
    private void stopAudioRec()  {
            ...
            Uri uri = Uri.parse("file://" + Environment.getExternalStorageDirectory().getPath() + "/Music/"+ mVideoFileName);
            mAdapter.addItem(new MediaItem(MediaItem.SDCARD, mVideoFileName,uri));
